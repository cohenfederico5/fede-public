...
app.layout = html.Div([html.H1("Automobile Sales Statistics Dashboard",style={'textalign:'center','color':'#503d36','font_size':24}),
...
@app.callback(Output(component_id='select-year', component_property='disabled'),
             Input(component_id='dropwdown_statistics',component_property='value'))
...
[Input(component_id='dropwdown_statistics', component_property='value'), Input(component_id='select-year', component_property='value')])
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [html.Div(className='chart_item', children=[html.Div(children=Y_chart1),html.Div(children=Y_chart2)],style={...}),
            html.Div(className='chart_item', children=[html.Div(children=Y_chart3),html.Div(children=Y_chart4)],style={...})]
